...
################################################################################
    ...
    def Level1StartUp(self):
        ...
        self.button1=Button(260, 430, 'triggerwall1')
    ...
    def ButtonCheck():
        if Main.GameProgress=='Level1Loop':
            if Main.player1.ButtonCheck()=='triggerwall1' and Main.triggerwall1remove:
                del Main.ObjectList[len(Main.ObjectList)-1]
                del Main.TriggerWallList[len(Main.TriggerWallList)-1]
            ...
            if Main.player1.ButtonCheck()=='triggerwall1': 
                Main.canvas.itemconfig(Main.button1.Image, image=Main.button1.ImageFile[1])
            else:
                Main.canvas.itemconfig(Main.button1.Image, image=Main.button1.ImageFile[0])         
...
#Start
Main=Main(Width=900, Height=600, Title='Platformer V1.1.2')
Main.MainStartUp()
