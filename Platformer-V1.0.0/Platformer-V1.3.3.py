...
#---------------------------------------------------------------------------
    ...
    def EventCheck(self):
        ...
        if self.Pressed['=']==True:
            ...
            self.ThruWallList=[]
            if self.LevelHack<5:
                self.LevelHack=self.LevelHack+1
            if self.LevelHack==5:
                self.Credits1Start()
            if self.LevelHack==4:
                self.Level4Start()
        ...
        if self.GameProgress=='START2':
            if self.Released[' ']==True:
                self.MainStartup2()
        #-------    
        if self.GameProgress=='START3':
            if self.Pressed[' ']==True:
                self.GameProgress='START4'
        #-------
        if self.GameProgress=='START4':
            if self.Released[' ']==True:
                self.Level1Start()
        #-------    
        ...
        if self.GameProgress=='Level4Start':
            if self.Pressed[' ']==True:
                self.Level4Startup()
        #-------
        if self.GameProgress=='Credits1Start':
            if self.Pressed[' ']==True:
                self.GameProgress='Credits1Start2'
        #-------
        if self.GameProgress=='Credits1Start2':
            if self.Released[' ']==True:
                self.Credits1Startup()
        #-------
        if self.GameProgress=='Credits1Loop':
            if self.Pressed[' ']==True:
                self.Credits1Shutdown()
        #-------
...
################################################################################
    ...
    def MainStartup(self):
        ...
        self.StartImageFile=PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\Title_Screen.gif")
    ...
    def MainStartup2(self):
        self.GameProgress='START3'
        self.canvas.delete(ALL)
        self.StartImageFile=PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\Title_Screen_Game.gif")
        self.StartImage=self.canvas.create_image(1, 1, anchor=NW, image=self.StartImageFile)
        self.canvas.update()
        while 1:
            self.EventCheck()
...
#==========================================================================================
    def Level1Start(self):
        ...
        self.StartImageFile=PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\Start_Screen2.gif")
    ...
    def Level1Startup(self):
            ...
            self.PlayImageFile=PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\PlayBackground.gif")
            self.PlayImage=self.canvas.create_image(1, 1, anchor=NW, image=self.PlayImageFile)
            ...
            self.wall8=Wall(700,0, 899, 430)#Drop-Down Right
            self.ObjectList.append(self.wall8)
            self.WallList.append(self.wall8)

            self.EndLocation=[900-60, 430+3, 900, 600]
            self.EndImage=self.canvas.create_rectangle(900-85, 430+3, 900-9, 570-2, outline="red", stipple="gray50", width=4)

            self.Level1Text=self.canvas.create_text(900/2, 80, fill='lightgreen', font=('times', 16), text=''' Daddy is the green player and Mommy is the pink player. (Mommy is taller for now!)\n Daddy, use "W" to jump and "A" and "D" to move.\n Mommy, use "I" to jump and "J" and "L" to move (Yes you will have to use those keys boo boooo)\n The objective is to get both players to the exit (red outlined area).''')
    ...
    def Level1ShutDown(self):
        ...
        self.TriggerWallList=[]
        self.ThruWallList=[]
        self.canvas.delete(self.wall1)
        self.wall1=None
        self.canvas.delete(self.wall2)
        self.wall2=None
        self.canvas.delete(self.wall3)
        self.wall3=None
        self.canvas.delete(self.wall4)
        self.wall4=None
        self.canvas.delete(self.wall5)
        self.wall5=None
        self.canvas.delete(self.wall6)
        self.wall6=None
        self.canvas.delete(self.wall7)
        self.wall7=None
        self.canvas.delete(self.wall8)
        self.wall8=None
        self.canvas.delete(self.player1)
        self.player1=None
        self.canvas.delete(self.player2)
        self.player2=None
        self.canvas.delete(self.EndImage)
        self.EndImage=None
        self.canvas.delete(ALL)
        self.Level2Start()
...
#==========================================================================================
    ...
    def Level2Startup(self):
            ...
            self.EndImage=self.canvas.create_rectangle(900-85, 7+3, 900-9, 110-2, outline="red", stipple="gray50", width=4)

            self.Level2Text=self.canvas.create_text(700, 200, fill='lightgreen', font=('times', 18), text='''You embark on a wonderful adventure\nfull of good and bad times. Sometimes\nlife is not easy and feels like a\nconstant up hill battle.\n\n(I may make spelling mistakes)''')
...
#==========================================================================================
    ...
    def Level3Startup(self):
            ...
            self.EndImage=self.canvas.create_rectangle(900-85, 430+3, 880-2, 570-2, outline="red", stipple="gray50", width=4)

            self.Level3Text=self.canvas.create_text(900/2, 40, fill='lightgreen', font=('times', 15), text='''Each player can push only one type of button. Daddy, you can push green buttons and Mommy, you can push red\nbuttons. Daddy, you can also go through any gray wall.''')
            self.Level3Text2=self.canvas.create_text(900/2, 130, fill='lightgreen', font=('times', 25), text='''Sometimes you may have to seperate to complete the task\nwhile you have to come to gether to solve others.\nIn the end you must remain together.''')
    ...
    def Level3ShutDown(self):
        ...
        self.canvas.delete(self.EndImage)
        self.EndImage=None
        self.canvas.delete(self.triggerwall1)
        self.triggerwall1=None
        self.canvas.delete(self.triggerwall2)
        self.triggerwall2=None
        self.canvas.delete(self.button1p1)
        self.button1p1=None
        self.canvas.delete(self.button1p2)
        self.button1p2=None
        self.canvas.delete(self.thruwall1)
        self.thruwall1=None
        self.canvas.delete(ALL)
        self.Level4Start()
#==========================================================================================
    ...
    def Level4Startup(self):
            ...
            self.wall5=Wall(0,0, 250, 430)#Drop-Down Left
            self.ObjectList.append(self.wall5)
            self.WallList.append(self.wall5)
            ...
            self.wall6=Wall(300, 100, 400, 110)#Start Platform
            self.ObjectList.append(self.wall6)
            self.WallList.append(self.wall6)
            ...
            self.wall9=Wall(800, 200, 900, 220)#Right Platform Up
            self.ObjectList.append(self.wall9)
            self.WallList.append(self.wall9)
            ...
            self.EndImage=self.canvas.create_rectangle(300, 500, 400, 570-2, outline="red", stipple="gray50", width=4)

            self.Level4Text=self.canvas.create_text(130, 150, fill='lightgreen', font=('times', 15), text='''Ocaisionally you will\nencounter difficult tests\nand trials. You must\nwork together.''')
    ...
    def Level4ShutDown(self):
        ...
        self.canvas.delete(self.triggerwall2)
        self.triggerwall2=None
        self.canvas.delete(self.triggerwall3)
        self.triggerwall3=None
        self.canvas.delete(self.triggerwall4)
        self.triggerwall4=None
        self.canvas.delete(self.button1p1)
        self.button1p1=None
        self.canvas.delete(self.button1p2)
        self.button1p2=None
...
#==========================================================================================
    def Credits1Start(self):
        self.GameProgress='Credits1Start'
        self.LevelHack=5
        self.canvas.delete(self.StartImage)
                    
        self.StartImageFile=PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\Start_Screen2.gif")
        self.Level1StartImage=self.canvas.create_image(0, 0, anchor=NW, image=self.StartImageFile)
        self.Level1StartText1=self.canvas.create_text(900/2, 600/2, fill='lightgreen', font=('times', 40), text='Credits')
        self.Level1StartText2=self.canvas.create_text(900/2, 600/2+50, fill='lightgreen', font=('times', 40), text='Press Space to Continue')
        self.canvas.update()
        while 1:
            self.EventCheck()
    ...
    def Credits1Startup(self):
            self.GameProgress='Credits1Startup'
            self.canvas.delete(self.Level1StartImage)
            self.canvas.delete(self.Level1StartText1)
            self.canvas.delete(self.Level1StartText2)
            ...
            self.PlayImageFile=PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\PlayBackground.gif")
            self.PlayImage=self.canvas.create_image(1, 1, anchor=NW, image=self.PlayImageFile)
            self.TextColours=['red','lightgreen','orange', 'lightgray', 'yellow']
            self.Credits1Text=self.canvas.create_text(900/2, 300, fill='lightgreen', font=('times', 30),text='''Sorry for the short game. I completed this in\nabout 6 days and I didn't have time to add any more.\n\nHappy Annaversary, Thankyou\nand hope you enjoyed the game!\n\n\n\n\n\n              Press "Q" to close''')
            self.Current='lightgreen'
            
            self.Credits1Loop()
        
    def Credits1Loop(self):
        self.GameProgress='Credits1Loop'
        Time=0
        while self.Play==True:
            self.EventCheck()
            Time=Time+0.005
            if Time>0.5:
                self.Choice=random.choice(self.TextColours)
                while self.Choice==self.Current:
                    self.Choice=random.choice(self.TextColours)
                self.Current=self.Choice
                self.canvas.itemconfig(self.Credits1Text, fill=random.choice(self.TextColours))
                Time=0
            self.canvas.update()
            time.sleep(0.005)
        exit(0)

    def Credits1Shutdown(self):
        #self.Credits2Startup()
        exit(0)
...
class Button(Objects):
    def __init__(self, PosX, PosY, Action, Player):
        ...
        self.CoordsY2=self.PosY2
        self.Coords=[self.CoordsX1, self.CoordsY1, self.CoordsX2, self.CoordsY2]
        self.ImageFile=[PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\ButtonUnpressed1.gif"), \
                        PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\ButtonPressed1.gif"), \
                        PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\ButtonUnpressed2.gif"), \
                        PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\ButtonPressed2.gif")]
        if Player==1:
...
class Player1(Players):
    def __init__(self, PosX, PosY):
        ...
        self.CoordsY2=self.PosY+self.Height
        self.Coords=[self.CoordsX1, self.CoordsY1, self.CoordsX2, self.CoordsY2]
        self.ImageFile=PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\Player1.gif")
        self.Image=Main.canvas.create_image(self.PosX, self.PosY, anchor=NW, image=self.ImageFile)
...
class Player2(Players):
    def __init__(self, PosX, PosY):
        ...
        self.CoordsY2=self.PosY+self.Height
        self.Coords=[self.CoordsX1, self.CoordsY1, self.CoordsX2, self.CoordsY2]
        self.ImageFile=PhotoImage(file="C:\\Sync\\Programming Projects\\Python\\Platformer-V1.0.0\\Player2.gif")
        self.Image=Main.canvas.create_image(self.PosX, self.PosY, anchor=NW, image=self.ImageFile)
        #self.Image=Main.canvas.create_rectangle(self.CoordsX1, self.CoordsY1, self.CoordsX2, self.CoordsY2, fill='light green')
