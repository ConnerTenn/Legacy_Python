...
################################################################################
    ...
    def Level1StartUp(self):
        ...
        self.button1=Button(260, 490, 'triggerwall1')
    ...
    def Level1Loop(self):
        while self.Play==True:
            ...
            if self.player1.ButtonCheck()=='triggerwall1' and self.triggerwall1remove:
                del self.ObjectList[len(self.ObjectList)-1]
                del self.TriggerWallList[len(self.TriggerWallList)-1]
                self.triggerwall1remove=False
                self.canvas.delete(self.triggerwall1.Image)
                self.canvas.itemconfig(self.triggerwall1.Image, image=Main.canvas.create_rectangle(self.triggerwall1.CoordsX1, self.triggerwall1.CoordsY1, self.triggerwall1.CoordsX2, self.triggerwall1.CoordsY2, outline='lightgreen', stipple='gray50', width=3))
            if self.player1.ButtonCheck()=='triggerwall1': 
                self.canvas.itemconfig(self.button1.Image, image=self.button1.ImageFile[1])
            else:
                self.canvas.itemconfig(self.button1.Image, image=self.button1.ImageFile[0])            
...
class TriggerWall(Objects):
    def __init__(self, PosX, PosY, PosX2, PosY2, InitialState=True):
        ...
        #self.Image=Main.canvas.create_image(self.PosX, self.PosY, anchor=NW, image=self.ImageFile)
        if InitialState:
            self.Image=Main.canvas.create_rectangle(self.CoordsX1, self.CoordsY1, self.CoordsX2, self.CoordsY2, fill='lightgreen')
        else: 
            self.Image=Main.canvas.create_rectangle(self.CoordsX1, self.CoordsY1, self.CoordsX2, self.CoordsY2, fill='lightgreen', stripple='gray50', width=3)
################################################################################
################################################################################  
class Button(Objects):
    def __init__(self, PosX, PosY, Action):
        self.Action=Action
        self.PosX=PosX
        self.PosY=PosY
        self.PosX2=PosX+20
        ...
        self.CoordsY2=self.PosY2
        self.Coords=[self.CoordsX1, self.CoordsY1, self.CoordsX2, self.CoordsY2]
        self.ImageFile=[PhotoImage(file="C:\\Users\\Conner\\Desktop\\Programming\\Python\\Programs\\Platformer-V1.0.0\\ButtonUnpressed.gif"), \
                        PhotoImage(file="C:\\Users\\Conner\\Desktop\\Programming\\Python\\Programs\\Platformer-V1.0.0\\ButtonPressed.gif")]
...
class Player1(Players):
    ...
    def ButtonCheck(self):
        for Buttons in Main.ButtonList:
