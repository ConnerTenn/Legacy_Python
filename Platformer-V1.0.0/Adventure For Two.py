...
################################################################################
    ...
    def MainStartup2(self):
        ...
        self.canvas.delete(ALL)
        self.StartImageFile=PhotoImage(file="C:\\Users\\Conner\\Desktop\\Programming\\Python\\Programs\\Platformer-V1.0.0\\Title_Screen_Game.gif")
        self.StartImage=self.canvas.create_image(1, 1, anchor=NW, image=self.StartImageFile)
        self.canvas.update()
        while 1:
            self.EventCheck()
...
#Start
Main=Main(Width=900, Height=600, Title='Adventure For Two')
Main.MainStartup()
