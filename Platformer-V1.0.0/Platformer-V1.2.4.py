...
#==========================================================================================
    ...
    def Level4Startup(self):
            ...
            self.wall9=Wall(550, 300, 700, 320)#Soon to be TriggerWall
...
#-------------------------------------------------------------------------------------------------------------
            ...
            if Main.player1.ButtonCheck()=='triggerwall2': 
                Main.canvas.itemconfig(Main.button1p1.Image, image=Main.button1p2.ImageFile[1])
            else:
                Main.canvas.itemconfig(Main.button1p1.Image, image=Main.button1p2.ImageFile[0])
